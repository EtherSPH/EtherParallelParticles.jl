...
@testset "NeighbourSystem" begin
    ...
    @testset "NeighbourSystem $DEVICE" begin
        ...
        @test EtherParallelParticles.Environment.toHost(parallel, neighbour_system.base_.neighbour_cell_index_count_) ==
        ...
        @test EtherParallelParticles.Environment.toHost(parallel, neighbour_system.active_pair_.adjacency_matrix_) ==
              IT[
            1 1
            1 0
        ]
