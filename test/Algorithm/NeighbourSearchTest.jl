...
@testset "NeighbourSearch" begin
    @testset "NeighbourSearch 2D" begin
        if USING_CPU == true
            @testset "NeighbourSearch 2D CPU" begin
                ...
                neighbour_system = EtherParallelParticles.Class.NeighbourSystem(
                    parallel,
                    domain,
                    active_pair,
                ...
                for i in 1:9
                    ...
                    particle_system.host_base_.float_properties_[i, particle_system.basic_index_.PositionVec + 1] =
                        xy[i, 2]
        ...
        if USING_CUDA == true
            @testset "NeighbourSearch 2D CUDA" begin
        ...
        if USING_ONEAPI == true
            @testset "NeighbourSearch 2D ONEAPI" begin
